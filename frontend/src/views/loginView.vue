    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <div>
        <label for="username" placeholder="username"
          class="block text-sm font-medium leading-6 text-gray-900">บัญชีผู้ใช้งาน</label>
        <div class="mt-2">
          <input id="username" name="username" placeholder="บัญชีผู้ใช้งาน" v-model="formData.username" type="text"
      ...
      <div>
        ...
        <div class="mt-2">
          <input id="password" name="password" placeholder="รหัสผ่าน" v-model="formData.password" type="password"
      ...
      <div>
        <button type="button" v-on:click="SIGN_IN"
      ...
      <button type="button" v-on:click="SIGN_UP"
        class="my-2.5 flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
        สมัครสมาชิก
      </button>
